...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_bram_cntlr_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire start_button_1;
  wire top_0_done_led_o;
  wire top_0_done_o;
  wire [31:0]top_0_ram_addr_o;
  wire [31:0]top_0_ram_dout_o;
  wire top_0_ram_en_o;
  wire [3:0]top_0_ram_wr_en_o;

  assign done_led = top_0_done_led_o;
  assign start_button_1 = start_button;
  ...
  design_1_top_0_0 top_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .done_led_o(top_0_done_led_o),
        .done_o(top_0_done_o),
        .ram_addr_o(top_0_ram_addr_o),
        .ram_dout_o(top_0_ram_dout_o),
        .ram_en_o(top_0_ram_en_o),
        .ram_wr_en_o(top_0_ram_wr_en_o),
        .rst_n(rst_ps7_0_50M_peripheral_aresetn),
        .start_i(start_button_1));
endmodule
