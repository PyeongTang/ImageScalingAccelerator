...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set done_led [ create_bd_port -dir O done_led ]
  set start_button [ create_bd_port -dir I start_button ]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins top_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins top_0/rst_n]
  connect_bd_net -net start_button_1 [get_bd_ports start_button] [get_bd_pins top_0/start_i]
  connect_bd_net -net top_0_done_led_o [get_bd_ports done_led] [get_bd_pins top_0/done_led_o]
  connect_bd_net -net top_0_done_o [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins top_0/done_o]
  connect_bd_net -net top_0_ram_addr_o [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins top_0/ram_addr_o]
  connect_bd_net -net top_0_ram_dout_o [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins top_0/ram_dout_o]
  connect_bd_net -net top_0_ram_en_o [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins top_0/ram_en_o]
  connect_bd_net -net top_0_ram_wr_en_o [get_bd_pins blk_mem_gen_0/web] [get_bd_pins top_0/ram_wr_en_o]

  # Create address segments
  create_bd_addr_seg -range 0x00040000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
