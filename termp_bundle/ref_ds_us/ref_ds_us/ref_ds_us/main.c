...
int main()
{
	...
	fopen_s(&fp_lenna_original, "C:\\Users\\qwer\\Desktop\\DSD_2022\\source\\lenna_256.bmp", "rb");
	...
	int i = 0;
	for (i = 0; i < 54; i++) {
		printf("%d = %u\n", i, header_info_lenna_original[i]);
	}
	...
	///////////////////////////////////////////////////////////////////////////////
	FILE* fp_lenna_coe;
	fopen_s(&fp_lenna_coe, "C:\\Users\\qwer\\Desktop\\DSD_2022\\source\\lenna_256.coe", "wb");
	...
	FILE* fp_lenna_ds;
	fopen_s(&fp_lenna_ds, "C:\\Users\\qwer\\Desktop\\DSD_2022\\source\\lenna_ds.bmp", "wb");
	...
	*(unsigned int*)&header_info_lenna_ds[22] = header_height_ds;
	...
	FILE* fp_lenna_us;
	fopen_s(&fp_lenna_us, "C:\\Users\\qwer\\Desktop\\DSD_2022\\source\\lenna_us.bmp", "wb");
